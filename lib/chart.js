...
Chart.prototype = {
  ...
  getChildPos: function (i) {
    var pos = this.c.center
      , left = i % this.c.childHoriz - this.c.childHoriz / 2;
    return [pos.x + left * this.c.ringWidth,
            pos.y + this.c.ringWidth * ((this.c.childHoriz/2 - 1.5) + parseInt(i/this.c.childHoriz, 10))];
  },
  child: function (i, link) {
